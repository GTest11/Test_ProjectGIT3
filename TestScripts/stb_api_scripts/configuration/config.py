...
condition: 0:Expected result can be either true or false", API_FAIL, "refImage",  Capt_x, Capt_y, Capt_width, Capt_height,
...
7:[ "Valid parameter, linked checkpoint", API_FAIL, SkyValidateLinkedCheckPoint ],
8:[ "Valid parameter, checkpoint with maximum name length", API_PASS, SkyValidateMaxLengthNameCheckpoint] }
#-------------------------------------------------------------------------------

#getOCRText
getOCRTextTestCaseCount = 6
...
language: wrong string", API_PASS, GET_OCR_SKY_HOME_SCREEN, DEFAULT_FILTER, "wrong"],
4:[ "InValid parameter: filters: wrong string", API_PASS, GET_OCR_SKY_HOME_SCREEN,
"wrong", DEFAULT_LANG], 5: [ "Valid parameters and multiple filters", API_PASS, GET_OCR_SKY_HOME_SCREEN,
...
tolerance, boundary condition: 0 :Expected result can be either true or false", API_FAIL, "refImage", "testImage", PIXEL_BASED_ALGORITHM, "0"],
7:[ "Valid parameters, tolerance, boundary condition: 100", API_PASS, "refImage",
...
2:[ "Valid QuickCapture, after DUT power off ", API_PASS, CAP_IMAGE_NAME]}
#-------------------------------------------------------------------------------
