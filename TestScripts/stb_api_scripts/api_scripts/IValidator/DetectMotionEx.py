...
#Description    : Validation of DetectMotionEx
#API Description: Detects motion in a specified region on the live stream.
#Author         : Arya L
#Date           : 14 March 2018, 22 March 2018, 21 June 2018
#Script Version : 3.0
...
try:
    from configuration.config import detectMotionExTestCaseCount, detectMotionExInputDict, homeKey
except ImportError:
...
inputDict = detectMotionExInputDict

APIname = "DetectMotionEx"
testCaseMax= detectMotionExTestCaseCount
exceptionOccured = False

#''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
#@Function Name	  	: TestAPI()
#@Description		: Tests the DetectMotionEx API with diffrent parameters and
...
def TestAPI(i):
    try:
        ...
        APIstatus = comLib.dut.validator.DetectMotionEx(x_coordinate, y_coordinate, width,
        height, timeout, tolerance)
