...
#Author         : Arya L
#Date           : 13 March 2018, 16 April 2018, 21 June 2018
#Script Version : 3.0
...
#@Description		: Tests the CacheImageFromUrl API with different parameters and logs its response (status, duration)
