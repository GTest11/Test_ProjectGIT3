...
#Author         : Arya L
#Date           : 14 March 2018, 16 April 2018, 21 June 2018
#Script Version : 3.0
...
def TestAPI(i):
    try:
        ...
        # Obtaining server time using GetServerTimeStamp API
        ...
        time2 = comLib.getTimestamp()
        comLib.logger.Log("QuickCaptured imagePath : "+imagePath)
        APIduration = comLib.getAPIduration(time1, time2)
        comLib.logger.Log( "Time taken by the QuickCapture to return:  " +str (APIduration))
        comLib.dut.CommitStepResult("API: QuickCapture duration ", str(APIduration))
