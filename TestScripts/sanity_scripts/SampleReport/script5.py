...
dut.CommitStepResult("API: ChangeOrientation ","PASSED")
dut.CommitStepResult("API: Duration ","23")
dut.CommitStepResult("API: Remarks/Reason ","got expected result")


dut.CommitStepResult("API: ChangeOrientation","FAILED")
...
dut.CommitStepResult("API: DoubleTapElement ","PASSED")
dut.CommitStepResult("API: Duration ","23")
dut.CommitStepResult("API: Remarks/Reason ","got expected result")


dut.CommitStepResult("API: GetElementCount ","PASSED")
dut.CommitStepResult("API: Duration ","23")
dut.CommitStepResult("API: Remarks/Reason ","got expected result")
