...
dut.CommitStepResult("StepName1:start","Start")
logger.Log("arg5 received: " + str(args[5]))
logger.Log("#############################")

dut.CommitStepResult("StepName1:end","Finished1")

dut.CommitStepResult("StepName2:Start" ,"Start")
logger.Log("arg4 received: " +str(args[4]))
logger.Log("#############################")

dut.CommitStepResult("StepName2:end" ,"Finished2")