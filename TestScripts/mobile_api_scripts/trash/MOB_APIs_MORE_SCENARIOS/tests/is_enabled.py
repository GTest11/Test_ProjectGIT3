    ...
    def check_enabled(self, elm_name):
        ...
        try:
            ...
            for c in range(0, count):
                selected = self.lib.is_enabled(elm_name)
                ...
                #     break
                time.sleep(5) # sleep between checks
    ...
    def run_api_test(self):
        ...
        try:
            ...
            for param in params.keys():
                ...
                if param == 0 and (not enabled) and enabled == params[param][1]:
                    status = "PASSED"
                elif enabled and enabled == params[param][1]:
                    status = "PASSED"
                else:
                    status = "FAILED"
                    test_result = False
