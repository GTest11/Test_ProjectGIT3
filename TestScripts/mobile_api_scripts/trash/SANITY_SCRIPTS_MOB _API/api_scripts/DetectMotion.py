        ...
        for key, value in test_data.items():
            ...
            if "Android" == platform:
                if detected:
                    ...
                    lib.logger.Error("Detect motion failed to identify video playback hence skipping VolumeUp and VolumeDown APIs")
            else:
                lib.logger.Warn("VolumeUp and VolumeDown APIs are only available for android devices")
