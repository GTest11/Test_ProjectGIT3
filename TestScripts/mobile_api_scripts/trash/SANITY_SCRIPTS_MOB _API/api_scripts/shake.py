...
apis_in_the_script = ("Shake", "Unlock"
                      )
config = lib.set_config()

# ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
# @Function Name	: test_api()
# @Description		: Tests the Shake and Unlock APIs and logs its response (status, duration)
...
def test_api():
    ...
    try:
        ...
        lib.report_elapsed_time(start_time, end_time, "Shake", "")
