...
class AndroidPhone(ConfigBase):
    ...
    activity = {
        ...
        "hotstar": "in.startv.hotstar.rocky.launch.splash.SplashActivity",
    }
    ...
    home = {
        'xpath': '//android.widget.ImageView[@id="in.startv.hotstar:id/toolbar_logo"]',
        'id' : 'in.startv.hotstar:id/toolbar_logo',
        'name'  : None,
        'class' : None,
        'access_id': None,
    }
    ...
    search_icon = {
    'xpath' : '//android.widget.TextView[@content-desc="Search"]',
    'id': 'in.startv.hotstar:id/action_search',
    'name': None,
    'class': None,
    'access_id': 'Search',
    ...
    search_box = {
        'xpath': '//android.widget.EditText[@id="in.startv.hotstar:id/search_text"]',
        'id': 'in.startv.hotstar:id/search_text',
        'name': None,
        'class': None,
        'access_id': None,
    }
    ...
    back_btn_search_box = {
        'xpath': '//android.widget.ImageView[@id="in.startv.hotstar:id/back"]',
        'id': 'in.startv.hotstar:id/search_text',
        'name': None,
        'class': None,
        'access_id': None,
    ...
    elm_attr = {
        ...
        'id': 'in.startv.hotstar:id/largeLabel',
        'name': None,
        'class': None,
        'access_id': None,
    ...
    movies_menu = {
        'xpath': "//android.widget.TextView[contains(@text,'Movies')]",
        'id': 'in.startv.hotstar:id/smallLabel',
        'name': None,
        'class': None,
        'access_id': None,
