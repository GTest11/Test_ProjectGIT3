...
class api_test(ApiTestBase):
    ...
    def run_api_test(self):
        ...
        try:
            ...
            elm_type, type = self.lib.choose_elm_type(self.config.elm_attr)
            if not type:
            ...
            apis_params = {
                "GetElementCount": (elm_type, self.config.search_icon[type]),
                "GetHeight": (elm_type, self.config.elm_attr[type]),
                "GetWidth": (elm_type, self.config.elm_attr[type]),
            }
