...
class api_test(apiTestBase):
    ...
    def run_api_test(self):
        ...
        try:
            ...
            self.logger.Log("Platform - {}".format(platform))

            if platform == "iOS":
                self.lib.report("Platform {} does not support this API".format(platform), "FAILED", ss_required=False)
                test_result = False
                return test_result
