...
# Date                  : 26-11-2018
# Script Version        : 1.1
# Modified by           : Lincy Robert
# Modification Details  : Added InitApp API
# APIs covered          : "LaunchApp, InitApp"
...
class api_test(apiTestBase):
    ...
    # class variables
    apis = ('LaunchApp','InitApp',)
    script_name = os.path.basename(__file__)

    def test_launch_or_init_app(self, api="LaunchApp"):
        '''
        ...
        try:
            ...
            if api == "LaunchApp":
                ...
                done = self.dut.InitApp(device_config)
    ...
    def close_app(self):
        ...
        try:
            ...
            if closed:
                ...
                status = "FAILED"
            self.lib.report_api_status(start_time, end_time, "CloseApp", status, ss_required=False)
        except Exception as e:
    ...
    def background_app(self):
        ...
        try:
            ...
            if backgrounded:
                ...
                status = "FAILED"
            self.lib.report_api_status(start_time, end_time, "SendAppToBackground", status, ss_required=False)
        except Exception as e:
        ...
        try:
            ...
            for api in self.apis:
                for param in params:
                    ...
                    done = self.test_launch_or_init_app(api)
                    if done == params[param][1] :
                        status = "PASSED"
                    else:
                        status = "FAILED"
                        test_result = False
                    self.lib.report("{} : {}".format(api, params[param][0]), status, True)
