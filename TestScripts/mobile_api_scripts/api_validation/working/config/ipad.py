...
class iPad(config_base):
    ...
    # ==================================================== VARIABLES
    # ================================================================================
    C_TAP_PLAYBACK = (133, 223)#(285, 691)
    C_WRONG_COORDS = (5000, 5000)
    c_img_search = (1180, 23, 32, 27)
    detect_motion_check = (57, 153, 676, 356, 20, 5, "10")
    C_DYN_IMG_COMP = (2, 11, 1291, 50)
    ...
    CACHE_VALID_URL_FOR_DYNAMIC_COMPARE = "http://10.47.166.48/TestImage/iPad/ipad.jpg"
    ...
    account_icon = {
        'xpath': '//XCUIElementTypeButton[@name="id.ui.navigation.account.button"]',
        'id': None,
    ...
    non_exist_ele = {
        'xpath': '//XCUIElementTypeOther[@name="id.ui.browse.back.button"]',
        'id': None,
        'name': 'id.ui.browse.back.button',
        'class': None,
        'access_id': None,
    }
    lengthy_text = {
    ...
    ele_with_dif_ind = {
        ...
        'name': 'account_panel_button',
        'class': None,
        'access_id': 'id.ui.navigation.account.button',
    }
    ...
    non_text_field = {
        'xpath': '//XCUIElementTypeOther[@name="iPad"]',
        'id': None,
        'name': None,
        'class': None,
        'access_id': None,
    ...
    is_element_present_params = {
        ...
        2: ["For an element with 'visible' False", API_FAIL, is_elm],
    }
