...
class ConfigBase(object):
    ...
    # ================================================================================
    imageSearchSingleOccurance = "CheckpointPatternSingleOccurance_zee"
    not_initialized = "not_initialized"
    ZeeValidateCheckPointICpixel = "zee_valIcPixel"
    ZeeValidateCheckPointICrmsel = "zee_valIcRmse"
    ZeeValidateCheckPointOCR = "Zee_Home_OCR"
    ParentCheckPoint = "Parent_checkpoint_Zee"
    CheckpointScreenToWait = "zee_valIcPixel"
    Multiline_Ocr = "Zee_Multiline_Ocr"
    ...
    home_in_home_menu = {
        ...
        "OnePlus5T": (),
        "MiA1712": (589, 736),
        "iPhone8Plus_11_0": (589, 736),
        "IpadFE": (),
        "iPhone7_11_0_3": (),
        "iPhone_6": (193, 413),
        "iPhone6sPlus": (),
        "iPhone8 Plus_11": (193, 413),
        "OnePlus2": (),
    ...
    c_swipe = {
        ...
        "iPhone6sPlus": (),
        "iPhone8 Plus_11": [200, 500, 200, 100, 600],
        "OnePlus2": (),
    ...
    c_capture_image = {
        ...
        "iPhone6sPlus": (),
        "iPhone8 Plus_11": (20, 20, 600, 600, "ref_image", 90, 0),
        "OnePlus2": (),
    ...
    searchbox_default_text = 'What are you looking for?'
    ...
    c_home = [118, 69, 131, 46]
    c_mline = [326, 262, 155, 201]
    ...
    validate_chkpt_params = {
        ...
        1: ["Valid parameter, IC checkpoint, pixel", API_PASS, ZeeValidateCheckPointICpixel],
        2: ["Valid parameter, IC checkpoint, rmse", API_PASS, ZeeValidateCheckPointICrmsel],
    ...
    wait_chkpt_match_params = {
        0: [
            "Valid parameter, OCR checkpoint", API_PASS, ZeeValidateCheckPointOCR,
            TIME_TO_WAIT, DEFAULT_WAITGAP
        ],
        1: [
            "Valid parameter, IC checkpoint, pixel", API_PASS, ZeeValidateCheckPointICpixel,
            TIME_TO_WAIT, DEFAULT_WAITGAP
        ],
        2: [
            "Valid parameter, IC checkpoint, rmse",
            API_PASS, ZeeValidateCheckPointICrmsel, TIME_TO_WAIT, DEFAULT_WAITGAP
        ],
        3: [
            "Valid parameter, already on checkpoint screen", API_PASS, ZeeValidateCheckPointOCR,
            TIME_TO_WAIT, DEFAULT_WAITGAP
        ],
    ...
    get_screen_transition_time_params = {
        ...
        "not_on_chkpt_screen": [
            ...
            (zee5_home_menu, T_MD_WAIT, INITIAL_DELAY)
        ],
