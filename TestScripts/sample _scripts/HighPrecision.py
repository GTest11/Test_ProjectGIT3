...
for i in range (10000):
	...
	if(dut.validator.validateCheckPoint((chkpt))):
		dut.controller.cacheCommand("Down")

		resp = ScriptingLibrary.APIResponse.ResponseData()
		inputParam1 = ScriptingLibrary.HighPrecisionValidationService.MotionParams()
		inputParam1.x_cord = 192
		inputParam1.y_cord = 249
		inputParam1.width = 116
		inputParam1.height = 45
		...
		inputParam3.x_cord = 192
		inputParam3.y_cord = 249
		inputParam3.width = 116
		inputParam3.height = 45
		...
		inputParam4.x_cord = 192
		inputParam4.y_cord = 249
		inputParam4.width = 116
		inputParam4.height = 45
		inputParam4.sensitivity = 10
		lstInputParam.Add(inputParam4)

		resp = dut.validator.DetectScreenChange(20, lstInputParam)
