...
try: 
    if(dut.InitApp(config)): 
        ...
        algorithm.Params = ""
        algorithmList.Add(algorithm) 
        request.Duration = 60 
        request.Token = "token" # we should use ReserveSlot API to get this token
