...
try: 
    ...
    if(dut.InitApp(config)): 
        ...
        dut.SendKeys(MobileScriptingLibrary.Constants.ElementType.Id, 'in.startv.hotstar:id/search_text', 'In Conversation with the Avengers')
        time.sleep(15)
        ...
        if(reservationResponse.Status): 
            ...
            algorithm.Params = ""
